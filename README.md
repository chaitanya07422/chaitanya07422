...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:kadavkolluchaitanya@gmail.com)
...
![Profile Views](https://komarev.com/ghpvc/?username=chaitanya07422&style=for-the-badge&color=39d353&label=Profile+Views)
![Followers](https://img.shields.io/github/followers/chaitanya07422?style=for-the-badge&logo=github&color=39d353&label=Followers)
![Repos](https://img.shields.io/badge/LeetCode-130%2B-FFA116?style=for-the-badge&logo=leetcode&logoColor=black)
![Focus](https://img.shields.io/badge/Focus-AI%20Systems-39d353?style=for-the-badge)
...
![NLTK](https://img.shields.io/badge/NLTK-2C3E50?style=flat-square)
...
![ML](https://img.shields.io/badge/Machine%20Learning-2C3E50?style=flat-square)
...
flowchart TB
  subgraph Clients["Clients"]
    UA["jobpilot-ai<br/>React User App"]
    AD["jobpilot-admin<br/>Internal UI"]
    WK["apply-worker<br/>Playwright"]
  end

  subgraph Edge["Edge"]
    NGX["Nginx Proxy<br/>API Gateway"]
  end

  subgraph Core["NestJS API"]
    AUTH["Auth<br/>JWT / Keys"]
    RES["Resume<br/>Extraction"]
    MATCH["Job Matching<br/>Scoring"]
    APPLY["Apply<br/>Orchestration"]
    Q["BullMQ<br/>Queues"]
  end
...
```mermaid
flowchart LR
  A["Input<br/>PDF / JD / Prompt"] --> B["Normalize<br/>& Validate"]
  B --> C["LLM Step<br/>Gemini / GPT"]
  C --> D{"Need retrieval?"}
  D -->|yes| E["Embed → Qdrant<br/>Retrieve context"]
  D -->|no| F["Direct generation"]
  E --> G["Augmented prompt"]
  G --> C2["LLM generation"]
  F --> C2
  C2 --> H["Post-process<br/>Schema / Safety"]
  H --> I["Persist<br/>DB + cache"]
  I --> J["Downstream<br/>Queue / API / UI"]
```
...
| **Frontend** | ![React](https://img.shields.io/badge/React-20232A?style=flat-square&logo=react&logoColor=61DAFB) ![Tailwind](https://img.shields.io/badge/Tailwind-06B6D4?style=flat-square&logo=tailwindcss&logoColor=white) ![Qt/QML](https://img.shields.io/badge/Qt%2FQML-41CD52?style=flat-square&logo=qt&logoColor=white) |
| **Database** | ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) ![MongoDB](https://img.shields.io/badge/MongoDB-47A248?style=flat-square&logo=mongodb&logoColor=white) ![Redis](https://img.shields.io/badge/Redis-DC382D?style=flat-square&logo=redis&logoColor=white) |
| **AI** | ![Vertex AI](https://img.shields.io/badge/Vertex%20AI-4285F4?style=flat-square&logo=googlecloud&logoColor=white) ![Gemini](https://img.shields.io/badge/Gemini-8E75B2?style=flat-square&logo=googlegemini&logoColor=white) ![RAG](https://img.shields.io/badge/RAG-39d353?style=flat-square) ![Qdrant](https://img.shields.io/badge/Qdrant-DC244C?style=flat-square) |
| **Cloud** | ![GCP](https://img.shields.io/badge/Google%20Cloud-4285F4?style=flat-square&logo=googlecloud&logoColor=white) ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white) |
...
![Languages](https://skillicons.dev/icons?i=java,ts,js,py,cpp)
![Backend](https://skillicons.dev/icons?i=nodejs,nestjs,fastify,graphql,grpc)
![Data](https://skillicons.dev/icons?i=postgres,mongodb,redis)
![AI Cloud](https://skillicons.dev/icons?i=gcp,docker)
![Frontend](https://skillicons.dev/icons?i=react,tailwind,qt)
...
![GitHub Trophies](https://github-trophies.vercel.app/?username=chaitanya07422&theme=gruvbox&no-frame=true&no-bg=true&margin-w=8&row=1&column=6)

<br/>

<img src="https://github-stats-extended.vercel.app/api?username=chaitanya07422&show_icons=true&theme=react&hide_border=true&count_private=true&include_all_commits=true&bg_color=0d1117&title_color=39d353&icon_color=39d353&text_color=c9d1d9" alt="GitHub Stats" height="170" />
<img src="https://github-readme-streak-stats-eight.vercel.app/?user=chaitanya07422&theme=react&hide_border=true&background=0d1117&ring=39d353&fire=39d353&currStreakLabel=39d353" alt="GitHub Streak" height="170" />

<br/>

<img src="https://github-stats-extended.vercel.app/api/top-langs/?username=chaitanya07422&layout=compact&theme=react&hide_border=true&langs_count=8&bg_color=0d1117&title_color=39d353&text_color=c9d1d9" alt="Top Languages" height="170" />
...
flowchart LR
  subgraph Q1["Q1"]
    A1["Harden JobPilot loops"]
    A2["Deeper system design study"]
  end
  subgraph Q2["Q2"]
    B1["First JobPilot users"]
    B2["Publish NestJS boilerplate"]
  end
  subgraph Q3["Q3"]
    C1["RAG eval utility OSS"]
    C2["200+ LeetCode"]
  end
  subgraph Q4["Q4"]
    D1["Meaningful OSS contrib"]
    D2["Architecture write-ups"]
  end
  A1 --> B1 --> C1 --> D1
  A2 --> B2 --> C2 --> D2
```
...
```mermaid
flowchart TB
  L0["Foundations<br/>Data structures · Backend APIs"] --> L1["Production Backend<br/>NestJS · gRPC · Redis · Postgres"]
  L1 --> L2["AI Systems<br/>RAG · Embeddings · Qdrant · Gemini"]
  L2 --> L3["Distributed Patterns<br/>Queues · Workers · Idempotency"]
  L3 --> L4["AI Infrastructure<br/>Eval · Agents · Observability"]
  L4 --> L5["Share<br/>OSS · Writing · Mentoring"]
```
...
[![Email Me](https://img.shields.io/badge/Send_Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:kadavkolluchaitanya@gmail.com)
